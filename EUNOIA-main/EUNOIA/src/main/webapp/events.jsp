...
<main style="display: flex; justify-content: center; align-items: center;margin-top: 60px" class="m-5">
  ...
  <div class="card m-4 p-2 ">
    <img class="card-img-top" src="bookevents.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">BOOK EVENTS</h5>
      <p class="card-text">The most beautiful things are not associated with money; they are memories and moments....</p>
      <a href="cpage.jsp" class="btn btn-light">Book Now</a>
    </div>
  </div>
</main>
