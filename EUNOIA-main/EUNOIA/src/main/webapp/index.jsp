...
<body style="background-image: url(event.jpg);background-repeat: no-repeat;background-size: cover;" >
...
<main class="text-center m-5 p-5" style=" color: rgb(84, 76, 64);">
<p><h1><i>"Occasion" </i>redirects here.</h1></p>
<p><h2>Events and celebrations are an integral part of human culture and society. They provide opportunities for people to come together, express joy, commemorate important milestones, and strengthen social bonds.</h2></p>
